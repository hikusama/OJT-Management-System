        ...
        if (!$errors) {
            ...
            if ($modifieds) {
                ...
                foreach ($modifieds as $modified) {
                    ...
                    } else if ($modified == 'Middlename') {
                        echo '<p class="formError" style="color:rgb(175 135 0)">' . $modified . ' Modified From "<span style="color:rgb(175 135 0); font-weight:900;">' . $mnameec . '</span>"</p>';
                    ...
                    } else if ($modified == 'Room') {
                        echo '<p class="formError" style="color:rgb(175 135 0)">' . $modified . ' Modified From "<span style="color:rgb(175 135 0); font-weight:900;">' . $roomec . '</span>"</p>';
                    } else if ($modified == 'Gender') {
                        echo '<p class="formError" style="color:rgb(175 135 0)">' . $modified . ' Modified From "<span style="color:rgb(175 135 0); font-weight:900;">' . $gnec . '</span>"</p>';
