...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    inner join department on department.department = supervisors.department 
...
?>
            <div class="showact" id="<?php echo $result["firstname"] . "_" . $result["middlename"] . "_" . $result["lastname"]; ?>">
                <i class="fa-regular fa-pen-to-square act1"></i>
                <i class="fa-solid fa-user-slash act2" id="del<?php echo $result["supervisor_info_id"] . "n" . $result["users_id"]; ?>"></i>
