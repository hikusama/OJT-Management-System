...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $searchQuery = filter_input(INPUT_POST, 'supervId', FILTER_SANITIZE_NUMBER_INT);
...
?>
        ...
        <div class="inptcont">
            <i class="fas fa-user"></i>
            <input id="mnamee" type="text" placeholder=" Middle name" name="mname" value="<?php echo $result['middlename'] ?>">
        </div>
        <div class="inptcont">
        ...
        <div class="inptcont">
            ...
            <input id="roome" type="text" placeholder="Room" name="room" value="<?php echo $result["room"] ?>">
        </div>
        <div class="inptcont">
