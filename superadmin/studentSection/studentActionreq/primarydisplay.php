...
?>
        ...
        <div class="inptcont">
            ...
            <input type="password"  autocomplete="new-password" id="passworde" placeholder="New Password" name="userpassword" class="border">
        </div>
        <div class="inptcont">
            <i class="fas fa-lock"></i>
            <input class="CP"  autocomplete="new-password" id="confirm_passworde" type="password" placeholder="Confirm Password" name="confirm_password">
        </div>
