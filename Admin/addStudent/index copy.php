<?php
    ...
    require_once '../addStudent/addStudent_view.php';
?>
        ...
        <div id="signup">
            <form id="signupForm" action="#">
                ...
                <div id="last">
                    ...
                    <div class="betsign">
                        <div class="top">
                            <label for="ch2"><a href="index.php">Done
                                </a></label>
                            <label class="noepek">Add Student</label>
                        </div>
                        <button id="btsign" type="submit" ><a href="../addStudent/addStudent.php">Add Student</a></button>
                    </div>
